    ...
    <style>
        * {
        ...
        .error-code .ufo {
            ...
            height: 160px;
            margin: 0 10px;
            background: url('/assets/images/ufo.png') center/cover no-repeat; /* Add your UFO image here */
...
<body>
    <div class="error-container">
        ...
        <div class="message">
            <h1 style="color: #6b7280">ERROR 404</h1>
            Page not found
        </div>
        <a href="{{ route('home') }}" class="home-button">Return to home page</a>
    </div>
</body>
</html>
